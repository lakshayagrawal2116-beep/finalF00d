...
const Footer = () => {
    return (
        <div className='footer' id='footer'>
            <div className='footer-content'>
                ...
                <div className='footer-content-center'>
                    ...
                    <ul>
                        ...
                        <li><Link to='/delivery' style={{ textDecoration: 'none', color: 'inherit' }}>Delivery</Link></li>
            ...
            <hr />
            <p className='footer-copyright'>Copyright 2026 &copy; Taste Runners.com-All right reserved</p>
        </div>
    )
}
